...
#
#	minimax_agent.py holds the MinimaxAgent class.
#   It uses the minimax method to decide the optimal move in the game tree.
#
...
class MinimaxAgent:
    ...
    # Uses minimax algorithm to make move decision. Increments nodes expanded.
